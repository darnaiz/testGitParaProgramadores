...
def buscar(sucursal, codigo, descripcion, fecha_ingreso, fecha_realizacion, dias_atraso, tree):  # esta rutina todabia no la decule
    valor = tree.selection()
    print(valor)  # ('I005',)
    item = tree.item(valor)
    print(
...
boton_buscar.grid(row=7, column=3)
